...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, Object>> handleMaxUploadSizeExceeded(
    ...
    if (message != null && message.contains("Maximum upload size")) {
      // 解析异常信息中的大小限制
      try {
        // 异常信息格式通常是: "Maximum upload size exceeded; nested exception is
        // java.lang.IllegalStateException:
        // org.apache.tomcat.util.http.fileupload.impl.FileUploadBase$SizeLimitExceededException:
        // the request was rejected because its size (15728640) exceeds the configured maximum
        // (10485760)"
    ...
    Map<String, Object> errorResponse =
        Map.of("success", false, "message", "文件大小不能超过" + sizeMessage + "，请选择较小的文件");
